...
AI Use
I did use AI tools while working on this project, but only as a learning aid. I used it to help understand concepts, debug issues, and improve my thinking—not just to copy answers. The goal was to learn how everything works.

Notes
This is a work in progress and part of a class assignment. More updates may be added later as I improve the project.
